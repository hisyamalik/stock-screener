...
├── bug-tracker.md                # Bug tracking and resolution history
...
│   │   ├── data/               # TSF/CSV history files generated by MQL5 bots
...
└── web/                        # React Frontend Dashboard
    ...
    └── src/
        ...
        ├── StockChart.jsx      # Recharts component for IDX screener stock charts
        ├── ForexChart.jsx      # Recharts component for Forex P&L live curves
